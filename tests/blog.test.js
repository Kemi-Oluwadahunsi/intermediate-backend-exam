...
describe("Blog Controller", () => {
  ...
  describe("GET /blog/:id", () => {
    test("It should respond with a single published blog", async () => {
      ...
      expect(response.body.message).toBe("Fetched Blog successfully");
      expect(response.body.data).toBeTruthy();
    });
  });
